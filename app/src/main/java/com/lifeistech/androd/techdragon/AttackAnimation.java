...
public class AttackAnimation extends AnimationSet {
    ...
    public AttackAnimation(Context context, ImageView imageView, TextView textView) {
        super(false);
    ...
    private class WhiteoutAnimation extends AnimationSet {
        ...
        public WhiteoutAnimation() {
            super(false);
            parentLayout = (FrameLayout) imageView.getParent();
    ...
    private class DamageAnimation extends AnimationSet {
        ...
        public DamageAnimation() {
            ...
            parentLayout = (FrameLayout) textView.getParent();
            ...
            String damageString = textView.getText().toString();
            ...
            for (int idx = 0; idx < damageString.length(); idx++) {
                ...
                damageTextViewSplit[idx].setTextColor(textView
                        .getCurrentTextColor());
